...
const config = { theme, corePlugins, plugins, content, darkMode, variants, presets, prefix, important, separator, safelist, blocklist }
export { config as default, theme, corePlugins, plugins, content, darkMode, variants, presets, prefix, important, separator, safelist, blocklist }